...
// The Angular app's templates (0038d3e) carried these as inline style attributes on every button
// and box. Written once here so the same declarations are not repeated per screen; the rendered
// result is identical.
