...
const { cornerControls, fakeMap, sourceTilesFor } = stub;
...
describe('MiniMap', () => {
  ...
  it('credits the tiles with the shared credit, shut to its "i", alone in its corner', () => {
    render(<MiniMap ring={SKEENA} />);

    expect(cornerControls('bottom-right')).toEqual(['attribution']);
  });
