...
import { AttributionControl, Layer, Map as MapGL, Source } from '@vis.gl/react-maplibre';
...
export default function MiniMap({ ring }: { ring: number[][] }) {
  ...
  return (
    ...
    >
      ...
      {/* Esri's terms want the tiles credited; compact, because the preview is a thumbnail. */}
