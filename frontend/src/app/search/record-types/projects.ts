...
/**
 * The sort to send. The search backend reports a field it could not honour under `meta[0].dropped`,
 * so a response naming `dateUpdated` means the index has no such field and the date sort would be
