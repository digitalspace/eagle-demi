 ...
 * here: the service splits a filter on commas into one `and[]` each and otherwise passes the text
 * through raw, which would tear a typed name in two and let a `#` end the query string.
 */
